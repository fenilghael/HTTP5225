...
<head>
    ...
    <title>Modify Educational Program</title>
    ...
    <div class="main-container">
        <div class="form-card">
            <div class="form-header">
                <h3 class="mb-0">
                    <i class="fas fa-edit"></i> Modify Educational Program
                </h3>
            </div>
            <div class="form-body">
                <form method="POST" action="{{ route('programs.update', $course->id) }}">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="d-flex gap-3">
                        <button type="submit" class="primary-btn">
                            <i class="fas fa-check-circle"></i> Update Program
                        </button>
